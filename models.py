...
class GeneralPayment(db.Model):
    ...
    covered_recipient_type = db.Column(db.String(30))
    teaching_hospital_ccn = db.Column(db.String(30))
    teaching_hospital_id = db.Column(db.String(30))
    teaching_hospital_name = db.Column(db.String(30))
    covered_recipient_profile_id = db.Column(db.String(30))
    covered_recipient_npi = db.Column(db.String(30))
    covered_recipient_first_name = db.Column(db.String(30))
    covered_recipient_middle_name = db.Column(db.String(30))
    covered_recipient_last_name = db.Column(db.String(30))
    ...
    covered_recipient_primary_type_1 = db.Column(db.String(30))
    ...
    applicable_manufacturer_or_applicable_gpo_making_payment_name = db.Column(db.String(30))
    ...
    form_of_payment_or_transfer_of_value = db.Column(db.String(30))
